...
- Data files:
  ...
  - Alert badges count BATCHES per status via `summarizeBatchStatusCounts`; leading **Need action** badge aggregates expired + expiring soon + sold out + understocked (not overstocked).
