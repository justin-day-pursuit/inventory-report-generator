...
- Data files:
  ...
  - Status clock (UI label: "Today's Date"): `APP_REFERENCE_DATE` (`2018-11-20`) near earliest expiration for testing. On-hand = Quantity in Stock. Understocked uses **both** drivers: stock ≤ min threshold **or** stock ≤ Quantity Sold (restock soon).
